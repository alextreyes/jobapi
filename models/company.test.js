...
describe("findAll", function () {
  // Test when no filter is applied, should return all companies
  ...
  // Test when all companies are requested, should return all companies
  ...
  // Test filtering companies by minimum number of employees
  ...
  // Test filtering companies by maximum number of employees
  ...
  // Test filtering companies by both minimum and maximum number of employees
  ...
  // Test when no companies match the filter, should return an empty list
